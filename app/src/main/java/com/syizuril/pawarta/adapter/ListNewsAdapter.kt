...
import com.syizuril.pawarta.NewsListFragmentDirections
 ...
 */
class ListNewsAdapter(): ListAdapter<Articles, ListNewsAdapter.ViewHolder>(ListNewsDiffCallback()) {
    ...
    class ViewHolder private constructor(
        ...
        fun bind(articles: Articles){
            ...
            binding.card.setOnClickListener {
                it.findNavController().navigate(NewsListFragmentDirections.actionNewsListFragmentToDetailArticle(articles))
            }
        }
...
class ListNewsDiffCallback: DiffUtil.ItemCallback<Articles>(){
